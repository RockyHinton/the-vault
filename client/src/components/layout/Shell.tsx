  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <div className="md:hidden flex items-center justify-between p-4 border-b border-border bg-card">
        <div className="flex items-center gap-4 font-display font-bold text-2xl tracking-tight text-white">
          <img src={logoImg} alt="3six9 Logo" className="h-8 w-auto object-contain opacity-90" />
      ...
      <aside className="hidden md:flex flex-col w-64 bg-sidebar border-r border-sidebar-border h-screen sticky top-0 shrink-0 z-30">
        <div className="p-6 border-b border-sidebar-border">
          <Link href="/projects">
            <div className="flex items-center gap-4 font-display font-bold text-2xl tracking-tight text-white cursor-pointer hover:opacity-80 transition-opacity">
              <img src={logoImg} alt="3six9 Logo" className="h-8 w-auto object-contain opacity-90" />
              <span>{APP_CONFIG.clientName}</span>
            </div>
          </Link>
