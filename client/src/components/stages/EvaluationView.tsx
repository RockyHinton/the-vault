...
import { FileText, User, Users, DollarSign, BarChart3, Upload, CheckCircle, XCircle } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="border-primary/20 bg-primary/5 shadow-lg shadow-primary/5">
          <CardHeader>
            ...
            <CardDescription>Is this project ready for development?</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
             ...
             <div className="pt-4 flex flex-col gap-2">
               <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold" onClick={handleApprove}>
